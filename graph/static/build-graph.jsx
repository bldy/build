...
var StringArray = React.createClass({
    ...
    var BuildGraph = React.createClass({
            ...
            d3.json("/graph", function(error, graph) {
                ...
                function addToGraph(g) {
                    for (var key in g.Edges) {
                        ...
                        targs[g.Edges[key].Target.Name].Status= g.Edges[key].Status;
                        var link  = {};
                        var p = key.split(":")
                        link.source = p[1];
                        link.target =p[0];
                ...
                function hashColor(d) {
                    ...
                    if (typeof targs[d.name] === "undefined") {
                        return "#c0c0c0"
                    }
                    console.log(targs[d.name].Status);
                    switch (targs[d.name].Status) {
